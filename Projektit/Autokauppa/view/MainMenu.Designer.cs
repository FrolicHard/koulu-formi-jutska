namespace Autokauppa.view
{
    partial class MainMenu
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fuelComboBox = new Autokauppa.FlatCombo();
            this.variComboBox = new Autokauppa.FlatCombo();
            this.malliComboBox = new Autokauppa.FlatCombo();
            this.merkkiComboBox = new Autokauppa.FlatCombo();
            this.moottorinTilavuus_textBox = new Autokauppa.CustomTextBox();
            this.hinta_textBox = new Autokauppa.CustomTextBox();
            this.mittarilukema_textbox = new Autokauppa.CustomTextBox();
